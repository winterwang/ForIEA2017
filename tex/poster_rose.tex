...
%\setlength\logowidth{\headerheight*\ratio{550px}{661px}}

\definecolor{kuldark}{rgb}{0.7, 0.13, 0.13}   % heading background peng
\definecolor{kulbgleft}{rgb}{0.96, 0.76, 0.76} % background fill gradient left
\definecolor{kulbgright}{rgb}{0.96, 0.76, 0.76} % background fill gradient right
\definecolor{kulheaderleft}{rgb}{0.7, 0.13, 0.13} % header fill gradient left
\definecolor{kulheaderright}{rgb}{0.7, 0.13, 0.13} % header fill gradient right
